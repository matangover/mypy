...
def generate_c_property_stub(name , obj , output , readonly )  :
    docstr = getattr(obj, '__doc__', None)
...
def generate_c_type_stub(module ,
                         class_name ,
                         obj ,
                         output ,
                         sigs   = {},
    ...
    for base in all_bases:
        if not any(issubclass(b, base) for b in bases) and base.__name__ != 'instance':
            bases.append(base)
    if bases:
